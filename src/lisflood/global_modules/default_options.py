...
default_options = {'EnKF': False,
                   ...
                   'reportedmaps': {'AreaTotalAbstractionFromSurfaceWaterM3': ReportedMap(
                       ...
                       'AreatotalIrrigationSWUseM3': ReportedMap(
                           name='AreatotalIrrigationSWUseM3',
                           output_var='areatotal_abstraction_SW_actual_irrigation_M3', unit='m3',
                       ...
                       'AreatotalWaterAbstractedfromLakesReservoirsM3': ReportedMap(
                           ...
                           output_var='areatotal_withdrawal_LakRes_actual_M3', unit='m3',
                           end=[], steps=['repTotalAbs'], all=[],
                           restrictoption=['nonInit', 'wateruse'], monthly=False, yearly=False),                           
                       'AvgDis': ReportedMap(name='AvgDis', output_var='avgdis', unit='m3/s',
                                             ...
                                             yearly=False),
                       'abstraction_allSources_actual_irrigation_M3MonthRegion': ReportedMap(
                           name='abstraction_allSources_actual_irrigation_M3MonthRegion',
                           output_var='abstraction_allSources_actual_irrigation_M3MonthRegion', unit='m3',
                           end=[], steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse','wateruseRegion'], monthly=True, yearly=False),                                             
                       'abstraction_SwGw_required_irrigation_M3MonthRegion': ReportedMap(
                           name='abstraction_SwGw_required_irrigation_M3MonthRegion',
                           output_var='abstraction_SwGw_required_irrigation_M3MonthRegion', unit='m3',
                           end=[], steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse','wateruseRegion', 'repWaterUse'], monthly=True, yearly=False),      
                       'abstraction_SwGw_actual_irrigation_M3MonthRegion': ReportedMap(
                           name='abstraction_SwGw_actual_irrigation_M3MonthRegion',
                           output_var='abstraction_SwGw_actual_irrigation_M3MonthRegion', unit='m3',
                           end=[], steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse','wateruseRegion', 'repWaterUse'], monthly=True, yearly=False),     
                       'abstraction_allSources_required_irrigation_M3MonthRegion': ReportedMap(name='abstraction_allSources_required_irrigation_M3MonthRegion',
                                                             output_var='abstraction_allSources_required_irrigation_M3MonthRegion',
                                                             unit='M3', end=[],
                                                             steps=['repWIndex'], all=[],
                                                             restrictoption=['nonInit', 'wateruse',
                                                                             'wateruseRegion',
                                                                             'indicator', 'repWaterUse'],
                       ...
                       'consumption_required_domestic_M3MonthRegion': ReportedMap(name='consumption_required_domestic_M3MonthRegion',
                                                                ...
                                                                restrictoption=['nonInit', 'wateruse',
                                                                                ...
                                                                                'indicator'],
                                                                monthly=True, yearly=False),                                                 
                       'consumption_required_energy_M3MonthRegion': ReportedMap(name='consumption_required_energy_M3MonthRegion',
                                                                output_var='consumption_required_energy_M3MonthRegion',
                                                                unit='M3', end=[],
                                                                steps=['repWIndex'], all=[],
                                                                restrictoption=['nonInit', 'wateruse',
                                                                                'wateruseRegion',
                                                                                'indicator'],
                                                                monthly=True, yearly=False),                                                  
                       'consumption_required_industry_M3MonthRegion': ReportedMap(name='consumption_required_industry_M3MonthRegion',
                                                                output_var='consumption_required_industry_M3MonthRegion',
                                                                unit='M3', end=[],
                                                                steps=['repWIndex'], all=[],
                                                                restrictoption=['nonInit', 'wateruse',
                                                                                'wateruseRegion',
                                                                                'indicator'],
                                                                monthly=True, yearly=False),                                                   
                       'consumption_required_livestock_M3MonthRegion': ReportedMap(name='consumption_required_livestock_M3MonthRegion',
                                                             output_var='consumption_required_livestock_M3MonthRegion',
                                                             unit='M3', end=[],
                                                             steps=['repWIndex'], all=[],
                                                             restrictoption=['nonInit', 'wateruse',
                                                                             'wateruseRegion',
                                                                             'indicator'],
                                                             monthly=True, yearly=False),                                                  
                       'consumption_required_irrigation_M3MonthRegion': ReportedMap(name='consumption_required_irrigation_M3MonthRegion',
                                                             output_var='consumption_required_irrigation_M3MonthRegion',
                                                             unit='M3', end=[],
                                                             steps=['repWIndex'], all=[],
                                                             restrictoption=['nonInit', 'wateruse',
                                                                             'wateruseRegion',
                                                                             'indicator'],
                                                             monthly=True, yearly=False),                                                   
                       'consumption_actual_irrigation_M3MonthRegion': ReportedMap(name='consumption_actual_irrigation_M3MonthRegion',
                                                             output_var='consumption_actual_irrigation_M3MonthRegion',
                                                             unit='M3', end=[],
                                                             steps=['repWIndex'], all=[],
                                                             restrictoption=['nonInit', 'wateruse',
                                                                             'wateruseRegion',
                       ...
                       'cumSeepTopToSubBOtherEnd': ReportedMap(name='cumSeepTopToSubBOtherEnd', output_var='cumSeepTopToSubBAv[0]',
                                                    unit='mm',
                                                    end=['InitLisflood'],
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),                                                                                                                                                                             'cumSeepTopToSubBForestEnd': ReportedMap(name='cumSeepTopToSubBForestEnd', output_var='cumSeepTopToSubBAv[1]',
                                                    unit='mm',
                                                    end=['InitLisflood'],
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),  
                       'cumSeepTopToSubBIrrigationEnd': ReportedMap(name='cumSeepTopToSubBIrrigationEnd', output_var='cumSeepTopToSubBAv[2]',
                                                    unit='mm',
                                                    end=['InitLisflood'],
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),     
                       'CumQEnd': ReportedMap(name='CumQEnd', output_var='CumQ',
                                                    unit='m3',
                                                    end=['InitLisflood'],
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),                              
                       ...
                       'FalkenmarkM3Capita1': ReportedMap(name='FalkenmarkM3Capita1',
                                                          ...
                                                          unit='M3Capita', end=[],
                                                          steps=['repWaterUse'], all=[],
                                                          restrictoption=['nonInit', 'wateruse',
                                                                          'indicator'], monthly=True,
                                                          yearly=False),
                                                          ## monthly=False
                       ...
                       'FossilGroundwaterUsedM3': ReportedMap(name='FossilGroundwaterUsedM3',
                                                                 ...
                                                                 unit='m3', end=[],
                                                                 steps=['repWIndex'], all=[],
                                                                 restrictoption=['nonInit', 'wateruse', 'wateruseRegion'],
                                                                 monthly=True, yearly=False),                                                       
                       ...
                       'LocalFreshwaterM3': ReportedMap(name='LocalFreshwaterM3',
                                                                 ...
                                                                 restrictoption=['nonInit', 'wateruse', 'wateruseRegion'],
                                                                 monthly=True, yearly=False),                                                                 
                       'LocalTotalWaterDemandM3': ReportedMap(name='LocalTotalWaterDemandM3',
                                                                 output_var='LocalTotalWaterDemandM3',
                                                                 unit='m3', end=[],
                                                                 steps=['repWIndex'], all=[],
                                                                 restrictoption=['nonInit', 'wateruse', 'wateruseRegion'],
                                                                 monthly=True, yearly=False),                                                                                                                                   
                       'LZAvInflowMap': ReportedMap(name='LZAvInflowMap', output_var='LZAvInflow',
                                                    ...
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),
                       'LZInflowCUMEnd': ReportedMap(name='LZInflowCUMEnd', output_var='LZInflowCUM',
                                                    unit='mm',
                                                    end=['InitLisflood'],
                                                    steps=[], all=[], restrictoption=[],
                                                    monthly=False, yearly=False),  
                       ...
                       'LakePrevInflowEnd': ReportedMap(name='LakePrevInflowEnd', output_var='LakeInflowOld',
                                                   unit='m3/s', end=['repEndMaps'], steps=[], all=[],
                                                   restrictoption=['nonInit', 'simulateLakes'],
                                                   monthly=False, yearly=False),
                       'LakePrevInflowState': ReportedMap(name='LakePrevInflowState', output_var='LakeInflowOld',
                                                     unit='m3/s', end=[], steps=['repStateMaps'],
                                                     all=[],
                                                     restrictoption=['nonInit', 'simulateLakes'],
                                                     monthly=False, yearly=False),
                       'LakePrevOutflowEnd': ReportedMap(name='LakePrevOutflowEnd', output_var='LakeOutflow',
                                                        unit='m3/s', end=['repEndMaps'], steps=[], all=[],
                                                        restrictoption=['nonInit', 'simulateLakes'],
                                                        monthly=False, yearly=False),
                       'LakePrevOutflowState': ReportedMap(name='LakePrevOutflowState', output_var='LakeOutflow',
                                                          unit='m3/s', end=[], steps=['repStateMaps'],
                                                          all=[],
                                                          restrictoption=['nonInit', 'simulateLakes'],
                                                          monthly=False, yearly=False),
                       ...
                       'MonthETpotMM': ReportedMap(name='MonthETpotMM', output_var='MonthETpotMM',
                                                   ...
                                                   yearly=False),
                      'TimeSinceStartPrerunChunkEnd': ReportedMap(name='TimeSinceStartPrerunChunkEnd', output_var='TimeSinceStartPrerunChunk',
                       ...
                       'OFOtherState': ReportedMap(name='OFOtherState', output_var='OFM3Other',
                                                   ...
                                                   all=[], restrictoption=['nonInit'], monthly=False,
                                                   yearly=False),
                       'PF1OtherMaps': ReportedMap(name='PF1Maps', output_var='pF0[0]', unit='mm',
                                              end=[], steps=[], all=['repPFMaps'],
                                              restrictoption=['nonInit', 'simulatePF'], monthly=False,
                                              yearly=False),
                       'PF2OtherMaps': ReportedMap(name='PF2Maps', output_var='pF1[0]', unit='mm',
                                              end=[], steps=[], all=['repPFMaps'],
                                              restrictoption=['nonInit', 'simulatePF'], monthly=False,
                                              yearly=False),
                       'PF3OtherMaps': ReportedMap(name='PF3Maps', output_var='pF2[0]', unit='mm',
                                              end=[], steps=[], all=['repPFMaps'],
                                              restrictoption=['nonInit', 'simulatePF'], monthly=False,
                                              yearly=False), 
                       ...
                       'PF2ForestMaps': ReportedMap(name='PF2ForestMaps', output_var='pF1[1]',
                                                    ...
                                                    restrictoption=['nonInit', 'simulatePF'],
                                                    monthly=False, yearly=False),    
                       'PF3ForestMaps': ReportedMap(name='PF3ForestMaps', output_var='pF2[1]',
                                                    unit='mm', end=[], steps=[],
                                                    all=['repPFMaps'],
                                                    restrictoption=['nonInit', 'simulatePF'],
                                                    monthly=False, yearly=False),      
                       'PF1IrrigationMaps': ReportedMap(name='PF1IrrigMaps', output_var='pF0[2]',
                                                    unit='mm', end=[], steps=[],
                                                    all=['repPFMaps'],
                                                    restrictoption=['nonInit', 'simulatePF'],
                                                    monthly=False, yearly=False),    
                       'PF2IrrigationMaps': ReportedMap(name='PF2IrrigaMaps', output_var='pF1[2]',
                                                    unit='mm', end=[], steps=[],
                                                    all=['repPFMaps'],
                                                    restrictoption=['nonInit', 'simulatePF'],
                                                    monthly=False, yearly=False), 
                       'PF3IrrigationMaps': ReportedMap(name='PF3IrrigMaps', output_var='pF2[2]',
                                                    unit='mm', end=[], steps=[],
                                                    all=['repPFMaps'],
                                                    restrictoption=['nonInit', 'simulatePF'],
                                                    monthly=False, yearly=False),    
                       'Percolation1ato1bOtherMaps': ReportedMap(name='Percolation1ato1bOtherMaps',
                       ...
                       'PotentialSurfaceWaterAvailabilityForIrrigationM3': ReportedMap(
                           ...
                           output_var='AreaTotalAvailableWaterFromChannelsM3', unit='m3',
                           end=[], steps=['repTotalAbs'], all=[],
                           restrictoption=['nonInit', 'wateruse'], monthly=False, yearly=False),
                       ...
                       'PrefFlowForestMaps': ReportedMap(name='PrefFlowForestMaps',
                                                         ...
                                                         restrictoption=['nonInit'], monthly=False,
                                                         yearly=False),                                                                                                                   
                       'PrefFlowIrrigationMaps': ReportedMap(name='PrefFlowIrrigationMaps',
                                                         output_var='PrefFlow[2]', unit='mm', end=[],
                                                         steps=[], all=['repPrefFlowMaps'],
                                                         restrictoption=['nonInit'], monthly=False,
                                                         yearly=False),
                       ...
                       'RegionMonthReservoirAndLakeStorageM3': ReportedMap(
                           ...
                           steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse', 'wateruseRegion','indicator', 'simulateLakes', 'simulateReservoirs'],
                           monthly=True, yearly=False),                         
                       'RegionMonthConsumptionRequiredM3': ReportedMap(name='RegionMonthConsumptionRequiredM3',
                                                                output_var='RegionMonthConsumptionRequiredM3',
                                                                unit='M3', end=[],
                                                                steps=['repWIndex'], all=[],
                                                                restrictoption=['nonInit', 'wateruse',
                                                                                'wateruseRegion',
                       ...
                       'RegionMonthConsumptionActualM3': ReportedMap(name='RegionMonthConsumptionActualM3',
                                                                output_var='RegionMonthConsumptionActualM3',
                                                                unit='M3', end=[],
                                                                steps=['repWIndex'], all=[],
                                                                restrictoption=['nonInit', 'wateruse',
                                                                                'wateruseRegion',
                       ...
                       'RegionMonthWaterAbstractedfromLakesReservoirsM3': ReportedMap(
                           ...
                           restrictoption=['nonInit', 'wateruse', 'wateruseRegion', 'indicator', 'simulateLakes', 'simulateReservoirs'],
                           monthly=True, yearly=False),
                       'RegionMonthAbstractionRequiredAllSourcesM3': ReportedMap(
                           name='RegionMonthAbstractionRequiredAllSourcesM3',
                           output_var='RegionMonthAbstractionRequiredAllSourcesM3', unit='M3',
                           end=[], steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse', 'wateruseRegion', 'indicator'],
                           monthly=True, yearly=False),                           
                       'RegionMonthAbstractionRequiredSurfaceGroundWaterM3': ReportedMap(
                           name='RegionMonthAbstractionRequiredSurfaceGroundWaterM3',
                           output_var='RegionMonthAbstractionRequiredSurfaceGroundWaterM3', unit='M3',
                           end=[], steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse', 'wateruseRegion', 'indicator'],
                           monthly=True, yearly=False),                                
                       'RegionMonthAbstractionRequiredSurfaceWaterM3': ReportedMap(
                           name='RegionMonthAbstractionRequiredSurfaceWaterM3',
                           output_var='RegionMonthAbstractionRequiredSurfaceWaterM3', unit='M3',
                           end=[], steps=['repWIndex'], all=[],
                           restrictoption=['nonInit', 'wateruse', 'wateruseRegion', 'indicator'],
                           monthly=True, yearly=False),  
                      'ReservoirAbstractionM3': ReportedMap(name='ReservoirAbstractionM3',
                       ...
                       'SMStressMap': ReportedMap(name='SMStressMap',
                                                  ...
                                                  restrictoption=['nonInit'], monthly=False,
                                                  yearly=False),
                       'SeepSubToGWotherMaps': ReportedMap(name='SeepSubToGWOtherMaps',
                                                            output_var='SeepSubToGW[0]', unit='mm',
                                                            end=[], steps=[],
                       ...
                       'TotalAbsGroundwater': ReportedMap(name='TotalAbsGroundwater',
                                                          ...
                                                          restrictoption=['nonInit', 'wateruse'],
                                                          monthly=False, yearly=False),
                       'TotalAbsSurfaceGroundwaterRegion': ReportedMap(name='TotalAbsSurfaceGroundwaterRegion',
                                                                output_var='MonthAbstractionRequiredSurfaceGroundWaterM3*self.var.M3toMM',
                                                                unit='mm', end=[],
                                                                steps=['repTotalAbs'], all=[],
                                                                restrictoption=['nonInit', 'wateruse',
                       ...
                       'TotalAbsSurface': ReportedMap(name='TotalAbsSurface',
                                                      output_var='abstraction_SW_required_M3*self.var.M3toMM',
                                                      unit='mm', end=[], steps=['repTotalAbs'],
                                                      all=[], restrictoption=['nonInit', 'wateruse'],
                                                      monthly=False, yearly=False),
                       'TotalAbsSurfaceRegion': ReportedMap(name='TotalAbsSurfaceRegion',
                                                            output_var='RegionMonthAbstractionRequiredSurfaceWaterM3',
                                                            unit='mm', end=[], steps=['repTotalAbs'],
                                                            all=[],
                                                            restrictoption=['nonInit', 'wateruse',
                       ...
                       'TotalAbstractionFromGroundwaterM3': ReportedMap(
                           ...
                           output_var='abstraction_GW_actual_M3', unit='m3', end=[],
                           steps=['repTotalAbs'], all=[], restrictoption=['nonInit', 'wateruse'],
                           monthly=False, yearly=False),
                       'TotalAbstractionFromSurfaceWaterM3': ReportedMap(
                           name='TotalAbstractionFromSurfaceWaterM3',
                           output_var='abstraction_SW_required_M3', unit='m3', end=[],
                           steps=['repTotalAbs'], all=[], restrictoption=['nonInit', 'wateruse'],
                           monthly=False, yearly=False),
                       'TotalPaddyRiceIrrigationAbstractionM3': ReportedMap(
                           name='TotalPaddyRiceIrrigationAbstractionM3',
                           output_var='PaddyRiceWaterAbstractionFromSurfaceWaterM3', unit='m3', end=[],
                           steps=['repTotalAbs'], all=[], restrictoption=['nonInit', 'wateruse','riceIrrigation'],
                           monthly=False, yearly=False),
                       ...
                       'UpstreamInflowUsedM3': ReportedMap(name='UpstreamInflowUsedM3',
                                                      ...
                                                      all=[], restrictoption=['nonInit', 'wateruse'],
                                                      monthly=True, yearly=False),     
                       'UpstreamInflowM3': ReportedMap(name='UpstreamInflowM3',
                                                      output_var='UpstreamInflowM3',
                                                      unit='M3', end=[], steps=['repWaterUse'],
                                                      all=[], restrictoption=['nonInit', 'wateruse'],
                                                      monthly=True, yearly=False),                                                                                            
                       ...
                       'WEI_Dem': ReportedMap(name='WEI_Dem', output_var='WEI_Dem', unit='-',
                                              ...
                                              restrictoption=['nonInit', 'wateruse', 'indicator'],
                                              monthly=True, yearly=False),
                       'WEI_Plus': ReportedMap(name='WEI_Plus', output_var='WEI_Plus', unit='-',
                                              end=[], steps=['repWIndex'], all=[],
                                              restrictoption=['nonInit', 'wateruse', 'indicator'],
                                              monthly=True, yearly=False),                                              
                   ...
                   'timeseries': {
                       ...
                       'GwLossAvUpsTS': TimeSeries(name='GwLossAvUpsTS', output_var='GwLossPixel', where='Gauges',
                                                   repoption=['repRateUpsGauges'], restrictoption=[], operation=['total']),
                       'GwLossTS': TimeSeries(name='GwLossTS', output_var='GwLossPixel', where='Sites',
                                              repoption=['repRate'], restrictoption=['nonInit'],
                                              operation=['']),
                       ...
                       'MassBalanceMMTSS': TimeSeries(name='MassBalanceMMTSS', output_var='MBErrorMM',
                                                      ...
                                                      restrictoption=['nonInit'], operation=['']),
                       'MassBalanceErrorSplitRoutingTSS': TimeSeries(name='MassBalanceErrorSplitRoutingTSS', output_var='MBErrorSplitRoutingM3',
                                                      where='Catchments', repoption=['repMBTs'],
                                                      restrictoption=['nonInit','SplitRouting'], operation=['']),      
                       'OutletDischargeErrorSplitRoutingTSS': TimeSeries(name='OutletDischargeErrorSplitRoutingTSS', output_var='OutletDischargeErrorSplitRouting',
                                                      where='Catchments', repoption=['repMBTs'],
                                                      restrictoption=['nonInit','SplitRouting'], operation=['']),  
                       'MBErrorStorageRatioTSS': TimeSeries(name='MBErrorStorageRatioTSS', output_var='MBErrorStorage',
                                                      where='Catchments', repoption=['repMBTs'],
                                                      restrictoption=['nonInit'], operation=['']),  
                       'AverageFractionsCatchmentTSS': TimeSeries(name='AverageFractionsCatchmentTSS', output_var='AverageFractions',
                                                      where='Catchments', repoption=['repMBTs'],
                                                      restrictoption=['nonInit'], operation=['']),                                                         
                       ...
                       'TotalRunoffTS': TimeSeries(name='TotalRunoffTS', output_var='TotalRunoff', where='Sites',
                                                   repoption=['repRateSites'], restrictoption=['nonInit'],
                                                   operation=['']),
                       'UZAvUpsTS': TimeSeries(name='UZAvUpsTS', output_var='UZPixel', where='Gauges',
                                                repoption=['repStateUpsGauges'], restrictoption=['nonInit'],
                                                operation=['total']),
                       ...
                       'actETPUpsTS': TimeSeries(name='actETPUpsTS',
                                                 ...
                                                 operation=['total']),
                       'actETPBUDYKOUpsTS': TimeSeries(name='actETPBUDYKOUpsTS',
                                                 output_var='ESActNoIrrPixel+self.var.TaNoIrrPixel+self.var.TaInterceptionNoIrrPixel',
                                                 where='Gauges', repoption=['repRateUpsGauges','repEtactBudykoTs'], restrictoption=['nonInit'],
                                                 operation=['total']),
                       'Theta1AvUpsTS': TimeSeries(name='Theta1AvUpsTS',
                                                 output_var='Theta1aPixel',
                                                 where='Gauges', repoption=['repStateUpsGauges'], restrictoption=['nonInit'],
                                                 operation=['total']),     
                       'Theta2AvUpsTS': TimeSeries(name='Theta2AvUpsTS',
                                                 output_var='Theta1bPixel',
                                                 where='Gauges', repoption=['repStateUpsGauges'], restrictoption=['nonInit'],
                                                 operation=['total']),  
                       'Theta3AvUpsTS': TimeSeries(name='Theta3AvUpsTS',
                                                 output_var='Theta2Pixel',
                                                 where='Gauges', repoption=['repStateUpsGauges'], restrictoption=['nonInit'],
                                                 operation=['total']),                                                                                                                                              
                       'Theta1TS': TimeSeries(name='Theta1TS',
                                                 output_var='Theta1aPixel',
                                                 where='Sites', repoption=['repStateSites'], restrictoption=['nonInit'],
                                                 operation=['']),     
                       'Theta2TS': TimeSeries(name='Theta2TS',
                                                 output_var='Theta1bPixel',
                                                 where='Sites', repoption=['repStateSites'], restrictoption=['nonInit'],
                                                 operation=['']),  
                       'Theta3TS': TimeSeries(name='Theta3TS',
                                                 output_var='Theta2Pixel',
                                                 where='Sites', repoption=['repStateSites'], restrictoption=['nonInit'],
                                                 operation=[''])},                                                                                                                                              
